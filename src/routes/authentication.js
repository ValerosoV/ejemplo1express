...
const express = require("express");             //llamado a Express
const router = express.Router();                //manejador de rutas de express
const userSchema = require("../models/user");   //llamado al esquema de usuarios

const bcrypt = require("bcrypt");               //libreria de encriptado

const jwt = require("jsonwebtoken");            //libreria web token para json
